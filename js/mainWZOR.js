$(document).ready(function() {
	...
	$('#increase-resource-1').click(function() {
		...
		slider.slider( "value", sliderCurrentValue + 194 );		
	...
	$('#increase-resource-2').click(function() {
		...
		sliderResource2.slider( "value", sliderCurrentResource2Value + 12000 );	
		ion.sound.play("button");
	});
	...
	$('#second-step-button').click(function() {	
		...
		if ( $('input#myonoffswitch').is(':checked') && !$('input#myonoffswitch1').is(':checked') ) {
			...
			progressBar(0, $('#progressBarConsole'));
			$('.message-header h3').html("PK XD Generator");	
			$(".message-content p.console-message").fadeIn();	
			var $console_message_username_msg = $('#coc-player-tag').val();
			var $console_message_platform_msg = $selected_platform;
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + '  </span>  is this your first time here? this is like the only legit Clash Royale Coins generator out there');
                        setTimeout(function() {
